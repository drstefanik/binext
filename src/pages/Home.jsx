...
// immagini: usa il tuo logo BI grande e l’illustrazione NEXT
  ...
  return (
    <div className="relative">
      ...
      <section className="relative">
        ...
        <div className="mx-auto max-w-7xl px-4 pt-16 pb-12 text-center relative">
          <motion.div
          ...
          >
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link to="/signup-school" className="px-6 py-3 rounded-2xl bg-binavy text-white shadow-soft hover:opacity-95">Registra la tua scuola</Link>
              <Link to="/signup-student" className="px-6 py-3 rounded-2xl border hover:bg-white">Sono uno studente</Link>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 grid md:grid-cols-2 gap-8 items-stretch">
        ...
        <motion.div {...card(.1)} className="rounded-3xl border bg-white p-6 shadow-soft flex flex-col">
          <div className="aspect-[16/9] w-full overflow-hidden rounded-2xl bg-slate-50">
            {/* il logo BI rimane perfettamente dentro senza sgranare */}
            <img src={logoBI} alt="British Institutes" className="w-full h-full object-contain p-6" />
          </div>
          <div className="mt-5">
            <h3 className="text-xl font-semibold mb-2">Scuola</h3>
            <p className="text-sm opacity-70 mb-4">Spazio riservato alla sede per condividere i materiali con le proprie classi.</p>
        ...
        <motion.div {...card(.2)} className="rounded-3xl border bg-white p-6 shadow-soft flex flex-col">
          <div className="aspect-[16/9] w-full overflow-hidden rounded-2xl bg-slate-50">
            <img src={illStudent} alt="" className="w-full h-full object-contain p-6" />
          </div>
          <div className="mt-5">
            <h3 className="text-xl font-semibold mb-2">Studente</h3>
            <p className="text-sm opacity-70 mb-4">Registrati con il Codice Scuola e accedi ai download della tua sede.</p>
